...
function JobCard(props) {
  ...
  return (
    <div  className=' mx-10 mb-4 md:mx-40'>
        <div className=' justify-between items-center px-6 py-4 bg-zinc-200 rounded-md border border-black shadow-lg hover:border-blue-500 hover:translate-y-1 hover:scale-103 md:flex'>
